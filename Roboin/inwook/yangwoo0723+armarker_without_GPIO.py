...
def get_thresholded_image(img):
    ...
    #color_combined[(r_g_condition & l_condition) & (s_condition | combined_condition)] = 1 - with yellow detect
...
def set_path(img, image_shape, thresholded):
    ...
    followpointy = 240 # change to robust value
...
# =============================================================================
            ...
            command = set_path(img, image_shape, thresholded)
            curv = command[0]
            offset = command[1]
            ...
            lookAheadPtX, lookAheadPtY = command[2], command[3]
...
# =============================================================================
            ...
            print(total_time)
            cv2.imshow('analysis',image_show)
            rawCapture.truncate(0)
